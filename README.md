[![Build Status](https://travis-ci.org/ida-mediafoundry/jetpack-advanced-drop-targets.svg?branch=master)](https://travis-ci.org/ida-mediafoundry/jetpack-advanced-drop-targets)
